...
export default function GestaoLayout({ children }) {
  ...
  const navLinks = [
    { href: "/gestao/mesa-ativa", label: "Mesas Ativas", icon: <MesaAtivaIcon />, show: true },
    { href: "/gestao/novo-pedido", label: "Novo Pedido", icon: <NewOrderIcon />, show: true },
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <aside className="hidden lg:flex w-64 bg-gray-800 text-white p-6 flex-col">
        <div>
          <h2 className="text-2xl font-bold mb-8">Painel {user?.restaurante?.nome || ''}</h2>
